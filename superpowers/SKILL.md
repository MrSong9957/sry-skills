...
- TRAE必须首先调用 using-superpowers 技能，全面扫描 .trae/skills 目录
...
7. **全面扫描**：TRAE必须全面扫描 .trae/skills 目录，发现并使用相关技能
8. **工具利用**：TRAE必须充分利用 agents、commands、hooks、lib 目录下的工具和配置
